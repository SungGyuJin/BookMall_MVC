# 프로젝트명 : The BooK (도서구매사이트) Spring 프로젝트
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;아직도 부족함이 많은 프로젝트입니다. UI부분이라던지 도서 상세 설명부분에 그림도 추가를 해야하고 개인정보수정 할 수 있는 기능 등등 많이 남아있습니다. Spring을 처음 학습 할 때는 "이게 뭐지.." 라는 어려움이 앞섰던 기억이납니다. 그래도 계속해서 반복하고 공부를 해보니 많은 개념들을 알게되었습니다. 하지만 아직까지는 미흡한 부분? 어려움이 남아 있습니다. 이 프로젝트는 남들 처럼 제대로 만들어진 "포트폴리오" 라는 것 보단 배우고 알아가는 과정에 중점을 둔 아직도 계속해서 진행중인 프로젝트로 봐주시면 감사하겠습니다. 개발 공부는 정말 끝이 없구나, 어느 정도 자리에 올라간 실력이라한들 하루가 멀다하고 계속해서 새로운 언어가, 기술이 생기기 때문에 공부를 소홀히 하면 안되겠다는 것을 다시금 깨달게되었습니다.
